...
- Hand-painted watercolor scenes, expressive pet animation, and ambient music
...
Do not add release notes for the first App Store version. Suggested copy for a
later update:

`Refined the garden across iPhone and iPad, polished pet interactions, postcards, and visitors, and improved save reliability.`
