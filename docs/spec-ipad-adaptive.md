...
| Medium | `600–819` | iPad mini 竖屏、Split View | 单列内容居中；卡片最大宽度封顶；网格 3 列 |
| Expanded | `820–1179` | iPad 11/13 竖屏、较宽小窗 | 左侧轻导航/状态 + 中央内容；网格 4 列 |
| Wide | `>= 1180` | iPad 11/13 横屏、大窗、Stage Manager | 三栏：左状态/导航，中院子舞台，右今日事件；网格 5 列 |
...
- **UI 面板层**：
  ...
  - 右侧：可选「今日院子」、今日来客、未读明信片、旅行动态、照料动作。
...
- iPad 13-inch portrait / landscape。
